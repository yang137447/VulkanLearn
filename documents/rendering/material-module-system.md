...
这份文档是对 [material-param-authoring-and-reflection.md](file:///d:/YYBWorkSpace/GitHub/VulkanLearn/documents/rendering/material-param-authoring-and-reflection.md) 的补充。前者解决参数声明和反射职责，这里专门讨论材质功能模块。
